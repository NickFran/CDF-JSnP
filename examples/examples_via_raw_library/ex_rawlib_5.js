...
.then((overview)=>{
    coordinatesDataStructure = overview.coordinates;

    AllLats = coordinatesDataStructure["latitude"]
    AllLons = coordinatesDataStructure["longitude"]

    FirstXYPair = [AllLats[0], AllLons[0]]

    console.log(FirstXYPair);
})